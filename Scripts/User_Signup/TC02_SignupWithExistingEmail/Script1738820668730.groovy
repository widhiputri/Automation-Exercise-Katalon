...
WebUI.setText(findTestObject('Object Repository/LoginAndSignupPage/inputNewUserSignupEmail'), 'janedoeqa@yopmail.com')

// Click the Signup button
WebUI.click(findTestObject('Object Repository/LoginAndSignupPage/buttonSignup'))

// Verify that the 'Email Address already exist!' message appears
